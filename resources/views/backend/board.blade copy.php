...
<div class="d-flex"><a href={{ route('getBoardNews', ['id'=>$board_id]) }} class="btn btn-secondary btn-lg ml-auto">Get Board News</a>
</div>
...
<div class="row">
    ...
    <div class="col-md-12">    
        ...
        <div class="row  mt-5">
                 <div class="col-md-9"><a href="{{ $website->url }}" target="_blank"><h2>{{ $website->name }}</h2></a></div>
        ...
        <table  class="table table-striped mt-2">
            @foreach ($website->news as $news)
             <tr>
                 ...
                 <td><a class="btn btn-sm btn-primary keep_position" href="{{ route('readNews', ['id'=>$news->id]) }}">Read</a></td>
                 @else
